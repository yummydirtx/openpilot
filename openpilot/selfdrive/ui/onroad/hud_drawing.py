...
def draw_set_speed(rect, *, is_metric, status, is_cruise_set, set_speed, font_semi_bold, font_bold, max_text, draw_text, measure_text):
  ...
  draw_text(font_semi_bold, max_text, rl.Vector2(x + (set_speed_width - max_text_width) / 2, y + 27),
  ...
  draw_text(font_bold, set_speed_text, rl.Vector2(x + (set_speed_width - speed_text_width) / 2, y + 77),
            FONT_SIZES.set_speed, 0, set_speed_color)


def draw_current_speed(rect, *, speed_text, unit_text, font_bold, font_medium, draw_text, measure_text):
